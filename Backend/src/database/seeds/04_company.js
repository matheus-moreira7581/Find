exports.seed = function(knex) {
    ...
    .then(function() {
        ...
        return knex('companies').insert([
            ...
            cpf: "54862458798", date_birth:"10/10/1991", address:"R. José da Costa Monteiro, 625", img_url:"https://res.cloudinary.com/dbehp0gsj/image/upload/v1594050778/uploads/Uncle_zpipvm.png", id_categories: 15}
        ]);
